...
namespace OpcCom
{
	...
	public class Interop
	{
		...
		public static object CreateInstance(Guid clsid, string hostName, NetworkCredential credential, bool useConnectSecurity = false)
		{
			...
			COSERVERINFO coserverInfo = serverInfo.Allocate(hostName, credential, useConnectSecurity);
		...
		/// </summary>
		public static object CreateInstanceWithLicenseKey(Guid clsid, string hostName, NetworkCredential credential, string licenseKey, bool useConnectSecurity = false)
		{
			ServerInfo     serverInfo   = new ServerInfo();
			COSERVERINFO   coserverInfo = serverInfo.Allocate(hostName, credential, useConnectSecurity);
